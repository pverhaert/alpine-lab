...
- Code Formatting & Controls: Automatic formatting, projector-friendly bold font toggle (enabled by default), interactive zoom controls (Ctrl + Mousewheel, Ctrl + Plus/Minus on standard and numeric keypads, Ctrl + 0 reset), adjustable font sizes, minimap toggle, and line numbers.
...
│   │   ├── EditorPane.tsx             # Monaco editor pane with zoom, controls & Emmet
